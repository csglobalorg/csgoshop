...
const file = path.join('c:/Users/CS/OneDrive/Desktop/CSGO APP', 'script.js');
let content = fs.readFileSync(file, 'utf8');

const newTemplate = \    const homeContentHtml = \\\
        <!-- 1. Hero Section -->
...
let newContent = content.replace(/const homeContentHtml = [\s\S]*?\\n    ;/, newTemplate);
